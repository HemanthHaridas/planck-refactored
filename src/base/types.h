...
namespace HartreeFock
{
    ...
    {
        bool _enabled = false;
        // Evaluation points. Stored in BOHR; the parser converts from the
        // declared input units. Either listed explicitly with `point` lines or
        // generated by the CHELPG grid when `_grid` is set -- the consumer sees
