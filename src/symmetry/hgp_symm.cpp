...
namespace
{
    inline double hgp_eri(const HartreeFock::ShellPair &spAB,
...
namespace HartreeFock::HeadGordonPople
{
        ...
        double tol_eri)
    {
        ...
        return HartreeFock::Symmetry::build_skeleton_eri(
            ...
            { return hgp_eri(ab, cd, ax, ay, az, bx, by, bz, cx, cy, cz, dx, dy, dz, kernel, omega); },
            tol_eri);
    }
