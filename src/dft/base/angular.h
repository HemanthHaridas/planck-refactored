#ifndef DFT_ANGULAR_H
#define DFT_ANGULAR_H

// Lebedev-Laikov angular quadrature grids for DFT integration.
//
// Ported from PySCF's LebedevGrid.py, which was adapted from CxLebedevGrid.cpp
// by Gerald Knizia, originally from Fortran by Christoph van Wuellen, originally
// from C by Dmitri Laikov (Moscow State University).
//
// Reference:
...
namespace DFT
{
    ...
    namespace detail
    {
        ...
        // Generate all equivalent points on the unit sphere under Oh (octahedral) symmetry.
        //
        //   code 0 : (0,0,1) and permutations                        6 points
        //   code 1 : (0,a,a) and permutations,  a = 1/sqrt(2)       12 points
        //   code 2 : (a,a,a) and permutations,  a = 1/sqrt(3)        8 points
        //   code 3 : (a,a,b) and permutations,  b = sqrt(1-2a^2)    24 points
        //   code 4 : (a,b,0) and permutations,  b = sqrt(1-a^2)     24 points
    ...
    // Weights sum to 4π, so they directly integrate over the full unit sphere.
