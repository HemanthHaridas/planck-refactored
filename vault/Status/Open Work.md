...
- **HOTSPOTS RANKED (2026-08-29, post-H5, HF/6-31G), and the top mergeable one is
  ...
  | everything, at once | 100 % | **OpenMP** — the largest remaining lever; rescoped, see `CCGEN_CC_OPENMP_SCOPE` |
